...
- [ ] **ACTION UTILISATEUR EN ATTENTE** : exécuter le diagnostic `unnest(categories)` sur `encadrement` (dans `018_categories.sql`, avant l'ÉTAPE 4) et communiquer le résultat pour compléter l'ÉTAPE 3 (`UPDATE encadrement.categories[]`) — dernière étape en suspens de cette phase
